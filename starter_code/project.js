// global variables
let dice, dice2;
let inputValue; // neccessary?
let values = []
let player1 = []
let player2 = []
let activePlayer1 = true; // if true, player1 is playing, otherwise player2
let failurePlayer1 = 0;
let failurePlayer2 = 0;
let confetti;
...
function rollDice() {
    // display dice
    document.getElementById('dice-image').style.display = 'inline-block';
    document.getElementById('dice2-image').style.display = 'inline-block';
...
// hide the dice
function hideDice() {
    if (document.getElementById('hide-btn').innerHTML == "Hide") {
        document.getElementById('dice-image').style.display = 'none';
        document.getElementById('dice2-image').style.display = 'none';
        document.getElementById('hide-btn').innerHTML = 'Show';
    } else if (document.getElementById('hide-btn').innerHTML == "Show") {
...
window.onload = () => {
    ...
    document.getElementById('hide-btn').addEventListener('click', hideDice);
    document.getElementById('fool-btn').addEventListener('click', fool);
